accept_key = input_check_pressed ("accept")//keyboard_check_pressed(vk_space)|| keyboard_check_pressed(ord("E"));
...
if draw_char == text_length[page] && page == page_number - 1
	...
	for (var op = 0; op < option_number; op++)
		...
		//draw_sprite_ext(txtb_spr[page], txtb_img, _txtb_x + 16, _txtb_y - _op_space*option_number + _op_space*op, _o_w/txtb_spr_w ,(_op_space-2)/txtb_spr_h, 0, c_white, 1)
		
		//the arrow
		if option_pos == op
			{
			draw_set_color (c_yellow)
			draw_sprite(sArrow, 0, _txtb_x + 10, _txtb_y - _op_space+ 49 + _op_space*op);
			}
		
		//the option text
		draw_text(_txtb_x - 3 + _op_bord + 5, _txtb_y - _op_space+ 40 + _op_space*op + 0, option[op]); //0 was 2
...
for(var c = 0; c < draw_char; c++)
	...
	//the text
	draw_text_color( char_x[c, page] + 15, char_y[c, page] + _float_y + 5, char[c, page], col_1[c, page], col_2[c, page], col_3[c, page], col_4[c, page], 1);
