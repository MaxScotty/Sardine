...
function __input_config_verbs()
{
    return {
        keyboard_and_mouse:
        {
            ...
            accept:  input_binding_key(ord("E")),
            cancel:  input_binding_key(vk_backspace),
            action:  input_binding_key(vk_enter),
            special: input_binding_key(ord("I")), //inventory 
        ...
        gamepad:
        {
            ...
            special: input_binding_gamepad_button(gp_face4), //inventory
			
			shift: input_binding_gamepad_button(gp_shoulderrb), //change for running
